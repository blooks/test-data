...
var log = require('coyno-log').child({component: 'MockupData'});
...
var insertWallet = function(callback) {
    ...
    mongo.db.collection('bitcoinwallets').insertMany([bip32wallet,singleAddressesWallet,electrumWallet,armoryWallet], callback);
};
...
testDataManager.prototype.initDB = function (callback) {
    log.debug('Initialising Database for mockup data:');
